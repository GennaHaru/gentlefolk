...
function displaySetting(index) {
    ...
    const width = paperEl.clientWidth - 40;
    ...
    const visualObj = ABCJS.renderAbc("paper", abcData, {
        responsive: 'resize', staffwidth: width, paddingleft: 0, paddingright: 0
    })[0];
...
async function renderMidi(visualObj) {
    ...
    synthControl.load("#midi-player", null, { displayRestart: true, displayPlay: true, displayProgress: true, displayWarp: true, customCss: true });
